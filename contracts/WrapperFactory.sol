...
contract WrapperFactory is Owned, MixinResolver, IWrapperFactory {
    ...
    bytes32 internal constant CONTRACT_SYNTH_HUSD = "SynthhUSD";
    ...
    function resolverAddressesRequired() public view returns (bytes32[] memory addresses) {
        ...
        addresses[0] = CONTRACT_SYNTH_HUSD;
    ...
    function synthhUSD() internal view returns (IERC20) {
        return IERC20(requireAndGetAddress(CONTRACT_SYNTH_HUSD));
    }
    ...
    function feesEscrowed() public view returns (uint) {
        return synthhUSD().balanceOf(address(this));
    }
    ...
    function distributeFees() external {
        ...
        if (amountHUSD > 0) {
            ...
            bool success = synthhUSD().transfer(feePool().FEE_ADDRESS(), amountHUSD);
