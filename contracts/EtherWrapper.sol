...
contract EtherWrapper is Owned, Pausable, MixinResolver, MixinSystemSettings, IEtherWrapper {
    ...
    function resolverAddressesRequired() public view returns (bytes32[] memory addresses) {
        ...
        newAddresses[1] = CONTRACT_SYNTHHUSD;
    ...
    /* ========== INTERNAL VIEWS ========== */
    function synthhUSD() internal view returns (ISynth) {
    ...
    function totalIssuedSynths() public view returns (uint) {
        ...
        return exchangeRates().effectiveValue(sETH, sETHIssued, hUSD).add(hUSDIssued);
    }
    ...
    function distributeFees() external {
        ...
        uint amountHUSD = exchangeRates().effectiveValue(sETH, feesEscrowed, hUSD);
        ...
        issuer().synths(hUSD).issue(feePool().FEE_ADDRESS(), amountHUSD);
