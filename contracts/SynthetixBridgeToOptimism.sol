...
contract SynthetixBridgeToOptimism is BaseSynthetixBridge, ISynthetixBridgeToOptimism, iOVM_L1TokenGateway {
    ...
    function notifyRewardAmount(uint256 amount) external {
        ...
        // NOTE: transfer HAKA to synthetixBridgeEscrow because RewardsDistribution transfers them initially to this contract.
    ...
    function _migrateEscrow(uint256[][] memory _entryIDs) private {
        ...
        for (uint256 i = 0; i < _entryIDs.length; i++) {
            ...
            if (escrowedAccountBalance > 0) {
                // NOTE: transfer HAKA to synthetixBridgeEscrow because burnForMigration() transfers them to this contract.
