...
It is a multi-token system, powered by HAKA, the Synthetix Network Token. HAKA holders can stake HAKA to issue Synths, on-chain synthetic assets via the [Staking dApp](https://staking.synthetix.io) The network currently supports an ever-growing [list of synthetic assets](https://www.synthetix.io/synths/). Please see the [list of the deployed contracts on MAIN and TESTNETS](https://docs.synthetix.io/addresses/)
...
contract MyContract {
  ...
  constructor(IAddressResolver _hakaResolver) public {
    synthetixResolver = _hakaResolver;
  }
...
haka.getAST({ source: 'Synthetix.sol' });
/*
{ imports:
...
haka.getTarget({ network: 'goerli', contract: 'ProxySynthetix' });
/*
{
	name: 'ProxySynthetix',
